...
namespace WebBanHang.Areas.Admin.Controllers
{
    ...
    public class NhaCungCapsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNCC,TenNCC,DiaChi,Email,Sdt,Fax")] NhaCungCap nhaCungCap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNCC,TenNCC,DiaChi,Email,Sdt,Fax")] NhaCungCap nhaCungCap)
        {
            if (ModelState.IsValid)
            {
